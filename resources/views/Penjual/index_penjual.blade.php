...
<body>
	<div class="container">
		...
		<div class="btn-group btn-group-toggle" data-toggle="buttons">
		    ...
		    <button class="btn btn-light btn-sm active" onclick="window.location.href='/penjual'">Penjual</button>
		    <button class="btn btn-success btn-sm" onclick="window.location.href='/Barang'">Barang</button>
		</div>
		<hr><br>
